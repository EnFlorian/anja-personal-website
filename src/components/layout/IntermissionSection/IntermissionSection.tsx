...
const IntermissionSection = () => {
  return (
    <section className="intermission-section">
      <div className="intermission-section__wrapper ">
        ...
        <div className="intermission-section__right-content">
          <h1 className="intermission-section__title">Intermission</h1>
          ...
          <div className="intermission-section__bars">
            <div className="intermission-section__bar">
              <div className="intermission-section__bar-description">
